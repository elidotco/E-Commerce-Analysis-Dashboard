...
const Header = () => {
  return (
    <header className="col-span-10 flex justify-between  h-16 px-10 pb-5">
      {/* Avatar */}
      <div className="flex gap-x-2">
        ...
        <div className="flex flex-col">
          <p className="text-[14px] font-thin text-gray-300 ">Hi, Eli!</p>
          <p className="font-bold text-lg">Welcome Back!</p>
        </div>
      </div>
      {/* Serch bar */}
      <div className="flex gap-x-2  items-center w-1/2">
        <InputGroup className="outline-0 border-0 bg-black rounded-full h-10 flex-1">
